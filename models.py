...
from keras.layers import Conv2D, AveragePooling2D, MaxPooling2D, GlobalAveragePooling2D, LeakyReLU
...
def resnet_v1(input_shape, depth, num_classes=10, use_bias = True, batchnorm_training = True):
    ...
    x = resnet_layer(inputs=inputs, use_bias = use_bias, batchnorm_training = batchnorm_training, name = 'first')
